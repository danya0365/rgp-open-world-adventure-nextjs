...
**การตรวจสอบ**:
- ✅ ถ้ามีตัวละครที่เล่นได้ → เข้าได้
- ❌ ถ้าไม่มีตัวละครเลย → แสดงหน้าเตือน "ยังไม่มีตัวละคร!"
...
**ข้อกำหนด**:
- ⚠️ **ต้องเลือกตัวละครก่อน** จึงจะเข้าหน้า Party ได้
...
### Q: เข้า /party แล้วแสดง "ยังไม่มีตัวละคร!"
**A**: คุณยังไม่ได้เลือกตัวละครเลย → ไปหน้า Characters ก่อน

### Q: คลิก "สำรวจโลก" จากหน้าแรกแล้วไม่ได้
**A**: ต้องมีทีมก่อน! ไปหน้า Characters หรือ Party ก่อน

### Q: เข้า /world แล้วแสดง "ยังไม่มีทีม!"
**A**: คุณยังไม่ได้เลือกตัวละครเข้าทีม → ไปหน้า Characters หรือ Party
