...
/**
 * Master Data: Playable Characters & Companions
 * Core character data for the game
 */

export const CHARACTERS_MASTER: Character[] = [
  {
    id: "char-001",
    name: "อาเธอร์",
    class: "warrior",
...

  {
    ...
    backstory: "ไคเดนเป็นนักสู้จากวัดบนภูเขา เขาฝึกฝนศิลปะการต่อสู้มาตลอดชีวิต",
    isPlayable: true,
    isRecruitable: true,
