...
// Combo Skills
export const mockComboSkills: ComboSkill[] = [
  {
    id: "combo-001",
...
export function getSkillsByElement(element: string): Skill[] {
  return mockSkills.filter((skill) => skill.element === element);
}

export function getUltimateSkills(): Skill[] {
  return mockSkills.filter((skill) => skill.type === "ultimate");
}
